...
// constants for creating virtual CB atoms
const double kTETH_ANG = 0.9128;
const double kCACBDIST = 1.538;
...
struct MAtom
{
	...
	std::string	GetName() const							{ return mName; }
        bool            TestAtomName(const std::string& cmpName) const   { return (! mName.compare(0,std::string::npos,cmpName)); }
...
class MResidue
{
  public:
	...
	const MAtom&		GetCBeta() const			       	{ return mCB; }

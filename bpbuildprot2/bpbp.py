...
from internal_coords import atom_to_internal_coordinates
from internal_coords import internal_to_atom_coordinates
from internal_coords import report_PIC, structure_rebuild_test
from PICIO import write_PIC, read_PIC
from ic_classes import IC_Residue, AtomKey, IC_Chain
from SCADIO import write_SCAD
from pic import write_PDB
...
for target in toProcess:
    ...
    if args.rama:
        ...
        for r in pdb_structure.get_residues():
            ...
            print(r, r.internal_coord.get_angle('psi'),
